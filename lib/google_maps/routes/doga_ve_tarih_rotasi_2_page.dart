...
class DogaVeTarihRotasiIkiPage extends StatefulWidget {
  const DogaVeTarihRotasiIkiPage({Key? key}) : super(key: key);

  @override
  State<DogaVeTarihRotasiIkiPage> createState() =>
      _DogaVeTarihRotasiIkiPageState();
}

class _DogaVeTarihRotasiIkiPageState extends State<DogaVeTarihRotasiIkiPage> {
  String rotaAdi = "2 . Doga ve Tarih Turizmi Rotası";
...
//--------------------------------Markers---------------------------------------
  Set<Marker> markers = {
    Marker(
      ...
      infoWindow:
      InfoWindow(title: "01 - ${RouteStrings.dogatarihrotasi2[0]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: sourceLocation,
    ),
    Marker(
      markerId: const MarkerId("destination1"),
      infoWindow:  InfoWindow(title: "02 - ${RouteStrings.dogatarihrotasi2[1]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
    ...
    Marker(
      ...
      infoWindow:
      InfoWindow(title: "03 - ${RouteStrings.dogatarihrotasi2[2]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination2,
    ),
    Marker(
      markerId: const MarkerId("destination3"),
      infoWindow:  InfoWindow(title: "04 - ${RouteStrings.dogatarihrotasi2[3]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination3,
    ),
    Marker(
      markerId: const MarkerId("destination4"),
      infoWindow:  InfoWindow(title: "05 - ${RouteStrings.dogatarihrotasi2[4]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination4,
    ),
    Marker(
      markerId: const MarkerId("destination5"),
      infoWindow:  InfoWindow(title: "06 - ${RouteStrings.dogatarihrotasi2[5]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
    ...
    return SpeedDial(
      ...
      children: [
        ...
        SpeedDialChild(
          ...
          onTap: () async {
            String url = """https://goo.gl/maps/KpzZsiScwa1ATFsDA""";
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) => Container(
          ...
          child: Column(
            children: [
              Container(
                height: RouteStrings.dogatarihrotasi2.length*55,
                ...
                child: ListView.builder(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                RouteStrings.dogatarihrotasi2[index],
                                style: TextStyle(
                                  fontSize: 18,
                  ...
                  itemCount: RouteStrings.dogatarihrotasi2.length,
