...
class TarihVeInancRotasiUcPage extends StatefulWidget {
  const TarihVeInancRotasiUcPage({Key? key}) : super(key: key);

  @override
  State<TarihVeInancRotasiUcPage> createState() =>
      _TarihVeInancRotasiUcPageState();
}

class _TarihVeInancRotasiUcPageState extends State<TarihVeInancRotasiUcPage> {
  String rotaAdi = "3. Tarih ve İnanç Turizmi Rotası";
...
//--------------------------------Markers---------------------------------------
  Set<Marker> markers = {
    Marker(
      ...
      infoWindow:
      InfoWindow(title: "01 - ${RouteStrings.tarihinancrotasi3[0]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: sourceLocation,
    ),
    Marker(
      markerId: const MarkerId("destination1"),
      infoWindow:  InfoWindow(title: "02 - ${RouteStrings.tarihinancrotasi3[1]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
    ...
    Marker(
      ...
      infoWindow:
      InfoWindow(title: "03 - ${RouteStrings.tarihinancrotasi3[2]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination2,
    ),
    Marker(
      markerId: const MarkerId("destination3"),
      infoWindow:  InfoWindow(title: "04 - ${RouteStrings.tarihinancrotasi3[3]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
    ...
    return SpeedDial(
      ...
      children: [
        ...
        SpeedDialChild(
          ...
          onTap: () async {
            String url = """https://www.google.com/maps/dir/Osmaniye,+Mehmet+Arif+Bey+K%C3%B6%C5%9Fk%C3%BC,+81650+Ak%C3%A7akoca%2FD%C3%BCzce/Yal%C4%B1,+Ak%C3%A7akoca+Merkez+Camii,+Plaj+Sokak,+Ak%C3%A7akoca%2FD%C3%BCzce/Hac%C4%B1+Yusuflar,+Ceneviz+Kalesi+Ve+Sahil+Plaj%C4%B1,+Ak%C3%A7akoca%2FD%C3%BCzce/Ahmet+Dede+T%C3%BCrbesi+Yolu,+Kepen%C3%A7%2FAk%C3%A7akoca%2FD%C3%BCzce/@41.0803435,31.1062364,15z/data=!3m1!4b1!4m26!4m25!1m5!1m1!1s0x409db22cc79f73db:0x40c43ef7e3293488!2m2!1d31.1351472!2d41.0874622!1m5!1m1!1s0x409db3d6d09ee9b1:0xd584b0edac634c7c!2m2!1d31.124711!2d41.0887617!1m5!1m1!1s0x409db15cbd2d9545:0x8282ce8e82f86931!2m2!1d31.0931014!2d41.0856934!1m5!1m1!1s0x409db10b42a15baf:0x2aa55a146c8af4c6!2m2!1d31.1059851!2d41.0704699!3e0""";
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) => Container(
          ...
          child: Column(
            children: [
              Container(
                height: RouteStrings.tarihinancrotasi3.length*55,
                ...
                child: ListView.builder(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                RouteStrings.tarihinancrotasi3[index],
                                style: TextStyle(
                                  fontSize: 18,
                  ...
                  itemCount: RouteStrings.tarihinancrotasi3.length,
