...
class YaylaVeDenizRotasiIkiPage extends StatefulWidget {
  const YaylaVeDenizRotasiIkiPage({Key? key}) : super(key: key);

  @override
  State<YaylaVeDenizRotasiIkiPage> createState() =>
      _YaylaVeDenizRotasiIkiPageState();
}

class _YaylaVeDenizRotasiIkiPageState extends State<YaylaVeDenizRotasiIkiPage> {
  String rotaAdi = "2. Yayla ve Deniz Turizmi Rotası";
...
//--------------------------------Markers---------------------------------------
  Set<Marker> markers = {
    ...
    Marker(
      ...
      infoWindow:  InfoWindow(title: "02 - ${RouteStrings.yayladenizrotasi2[1]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
    ...
    Marker(
      ...
      infoWindow:
      InfoWindow(title: "03 - ${RouteStrings.yayladenizrotasi2[2]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination2,
    ),
    Marker(
      markerId: const MarkerId("destination3"),
      infoWindow:  InfoWindow(title: "04 - ${RouteStrings.yayladenizrotasi2[3]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination3,
    ),
    Marker(
      markerId: const MarkerId("destination4"),
      infoWindow:  InfoWindow(title: "05 - ${RouteStrings.yayladenizrotasi2[4]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination4,
    ),
    Marker(
      markerId: const MarkerId("destination5"),
      infoWindow:  InfoWindow(title: "06 - ${RouteStrings.yayladenizrotasi2[5]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination5,
    ),
    Marker(
      markerId: const MarkerId("destination6"),
      infoWindow:  InfoWindow(title: "07 - ${RouteStrings.yayladenizrotasi2[6]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      position: destination6,
    ),
    Marker(
      markerId: const MarkerId("destination7"),
      infoWindow:  InfoWindow(title: "08 - ${RouteStrings.yayladenizrotasi2[7]}"),
      icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) => Container(
          ...
          child: Column(
            children: [
              Container(
                height: RouteStrings.yayladenizrotasi2.length*55,
                ...
                child: ListView.builder(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                RouteStrings.yayladenizrotasi2[index],
                                style: TextStyle(
                                  fontSize: 18,
                  ...
                  itemCount: RouteStrings.yayladenizrotasi2.length,
